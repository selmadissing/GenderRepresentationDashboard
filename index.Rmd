...
<p style="font-size:13px; color:black;">Music has always been a part of my life for as long as I can remember and I find the way a message can be spread through music lyrics and make an impact very intriguing. Therefore the choice to conduct a study concerning the impact feminist connotations in music have on the user was sound.  
</p>
...
t_test <- data.frame (
  ...
  "95% CI" = c("-0.72 ; -0.055","-0.074 ; 0.56","-0.36 ; 0.22","-0.92 ; -0.22","-1.03 ; -0.39","-0.31 ; 0.85","-1.94 ; -1.27","-4.37 ; -1.27"),
